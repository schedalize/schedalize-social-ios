...
struct CalendarTemplates {
    static let all: [CalendarTemplate] = [
        ...
        CalendarTemplate(title: "Day 2: Building in Public Intro", description: "Introduce the journey", task_type: "post", platform: "twitter", mood: "excited", template_content: "We're building Schedalize - scheduling software for beauty pros who are tired of the DM chaos. Following along as we build this thing from scratch."),
        ...
        CalendarTemplate(title: "Day 5: Behind the Scenes", description: "Show development progress", task_type: "post", platform: "twitter", mood: "tired", template_content: "Late night coding session. Working on the booking confirmation flow - making sure it actually feels like a human sent it, not a robot."),
        ...
        CalendarTemplate(title: "Day 7: Rest Day Reflection", description: "Lighter Sunday content", task_type: "post", platform: "twitter", mood: "grateful", template_content: "Sunday reset. This week we shipped the basic booking flow. Next week: reminders. Small steps."),
        // WEEK 2
        ...
        CalendarTemplate(title: "Day 10: Client Feedback", description: "Social proof", task_type: "post", platform: "twitter", mood: "grateful", template_content: "Got our first real feedback from a beta user today. 'Finally, something that doesn't look like it was made in 2010.' That's exactly what we're going for."),
        ...
        CalendarTemplate(title: "Day 12: Building Update", description: "Progress share", task_type: "post", platform: "twitter", mood: "focused", template_content: "Working on calendar sync this week. The goal: one source of truth, no matter where the booking comes from."),
        ...
        CalendarTemplate(title: "Day 14: Week 2 Milestone", description: "Progress celebration", task_type: "post", platform: "twitter", mood: "grateful", template_content: "Two weeks of building. Reminders working, basic scheduling done. 47 people on the waitlist. Not huge numbers, but it's real."),
        // WEEK 3
        ...
        CalendarTemplate(title: "Day 16: Behind the Design", description: "Building in public", task_type: "post", platform: "twitter", mood: "excited", template_content: "Spent the morning on button colors. Sounds trivial but the details matter. If it doesn't feel premium, it's not premium."),
        ...
        CalendarTemplate(title: "Day 19: Feature Preview", description: "Tease upcoming feature", task_type: "post", platform: "twitter", mood: "excited", template_content: "Working on something new: a booking page you can actually be proud to share. Clean, professional, reflects your brand. Coming soon."),
        ...
        CalendarTemplate(title: "Day 21: Week 3 Reflection", description: "Progress share", task_type: "post", platform: "twitter", mood: "grateful", template_content: "Week 3 done. Booking page is taking shape. 62 people on waitlist now. Every signup is motivation to keep going."),
        // WEEK 4
        ...
        CalendarTemplate(title: "Day 23: User Story", description: "Social proof", task_type: "post", platform: "twitter", mood: "grateful", template_content: "First beta user just told us they saved 3 hours this week not answering availability questions. 3 hours. That's the point."),
        ...
        CalendarTemplate(title: "Day 26: Milestone Celebration", description: "Growth share", task_type: "post", platform: "twitter", mood: "excited", template_content: "100 people on the waitlist. A month ago this was just an idea. Thanks to everyone who's following along and giving feedback."),
        ...
        CalendarTemplate(title: "Day 28: Looking Ahead", description: "Vision post", task_type: "post", platform: "twitter", mood: "focused", template_content: "Next on the list: payment integration. Because collecting deposits shouldn't require a separate app and a spreadsheet."),
        // DAYS 29-30
        ...
        CalendarTemplate(title: "Day 30: What's Next", description: "Forward-looking", task_type: "post", platform: "twitter", mood: "excited", template_content: "Month one: done. Month two: payments, more integrations, and hopefully our first paying customers. Let's see where this goes.")
    ]
}
